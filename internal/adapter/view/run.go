...
func Run(ctx context.Context, cells []domain.Cell, templates []string, currentCell string, reload func() ([]domain.Cell, error), enter func(domain.Cell) tea.Cmd, goRoot func() error, delete func(domain.Cell) error, markDone func(domain.Cell) (domain.Cell, error), fork func(issue string, template string, input string) tea.Cmd) (Result, error) {
	_ = ctx
