...
func (a GitSourceAdapter) CreateSource(ctx context.Context, source domain.Source, worktree string) error {
	args := append(a.gitArgs(source.Path), "worktree", "add", a.worktreePath(worktree), "-b", source.Branch)
